...
export const SecurityTrust = () => {
  ...
  return (
    <section id="security" className="bg-white py-16 border-t border-gray-200">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {securityFeatures.map((feature, index) => (
            ...
            >
              <div className="bg-gray-50 rounded-xl p-8 hover:shadow-medium transition-shadow h-full">
                <div className="w-12 h-12 bg-primary-blue text-white rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:bg-primary-600 transition-colors">
                  {feature.icon}
                </div>
        ...
        <div className="text-center mt-12 pt-8 border-t border-gray-200">
          <p className="text-sm text-gray-500 max-w-2xl mx-auto">
            {t('home.security.complianceNote')}
          </p>
        </div>
      </div>
    </section>
